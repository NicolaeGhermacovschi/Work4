...
public class Computer {
	...
	public void addComponents(){
		...
		processor.setNameDevace("Core i3");
		...
		motherboard.setNameDevace("Gigabyte H510M");
		...
		hardDrive.setNameDevace("Samsung 870 QV");
		...
		monitor.setNameDevace("Philips 243V7QSB");
		...
		mouse.setNameDevace("Mouse Logitech G502");
		...
		keyboard.setNameDevace("HYPERX Alloy Origins Core RGB");
